...
const routerList = [
  ...
  // 申请
  {
    ...
    children: [
      { name: 'applyFirst', path: 'first', component: LegalInfo, meta: { auth: false, title: '额度申请', needIntercept: false } },
      { name: 'applySecond', path: 'second', component: EnterpriseInfo, meta: { auth: false, title: '额度申请', needIntercept: false } },
